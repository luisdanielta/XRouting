...
export class ComponentService {
    ...
    async create(component: Component): Promise<Component> {
        ...
        return this.apiClient.request<Component>(this.baseEndpoint, {
            method: 'POST',
    ...
    async findById(id: string): Promise<Component | null> {
        return this.apiClient.request<Component>(`${this.baseEndpoint}/${id}`, {
            method: 'GET'
    ...
    async delete(id: string): Promise<boolean> {
        return this.apiClient.request<void>(`${this.baseEndpoint}/${id}`, {
            method: 'DELETE'
        }).then(() => true).catch(() => false);
    }

    async findAll(): Promise<Component[]> {
        return this.apiClient.request<Component[]>(this.baseEndpoint + "s", {
            method: 'GET'
        }).then(res => res.data);
    }
}
