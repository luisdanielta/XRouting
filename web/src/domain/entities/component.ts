...
export const ComponentSchema = z.object({
  ...
  missions: z.array(z.string()).default([]).describe('The missions this component has been a part of'),
  hasSubcomponents: z.boolean().default(false).describe('Whether this component has subcomponents')
});
